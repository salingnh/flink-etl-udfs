...
normalize_account_identifier = _s(common.normalize_account_identifier_value)
...
# Vietnam-specific: chỉ giữ logic thật sự phụ thuộc quy ước Việt Nam.
...
# CTI / healthcare / finance / supply chain / industrial / geospatial standards.
